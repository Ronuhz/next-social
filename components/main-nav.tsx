...
const MainNav = async () => {
	...
	return (
		<header className='fixed top-0 z-20 w-screen'>
			<nav className='flex w-full flex-row items-center justify-between px-6 pb-1 pt-2 backdrop-blur-lg sm:px-8 standalone:items-end standalone:pt-12 standalone:sm:pt-2'>
				<Link href='/'>
